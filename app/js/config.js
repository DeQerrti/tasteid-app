...
const TYPE_PLURAL = {
  anime:  [i18n("аниме"),              i18n("аниме"),               i18n("аниме")],
  manga:  [i18n("манга"),              i18n("манги"),               i18n("манг")],
  manhwa: [i18n("манхва"),             i18n("манхвы"),              i18n("манхв")],
  manhua: [i18n("маньхуа"),            i18n("маньхуа"),             i18n("маньхуа")],
  novel:  [i18n("ранобэ"),             i18n("ранобэ"),              i18n("ранобэ")],
  movie:  [i18n("фильм"),              i18n("фильма"),              i18n("фильмов")],
  show:   [i18n("сериал"),             i18n("сериала"),             i18n("сериалов")],
  dorama: [i18n("дорама"),             i18n("дорамы"),              i18n("дорам")],
  book:   [i18n("книга"),              i18n("книги"),               i18n("книг")],
  game:   [i18n("игра"),               i18n("игры"),                i18n("игр")],
  gacha:  [i18n("гача"),               i18n("гачи"),                i18n("гач")],
};
...
const TAGS_MAP = {
  ...
  "Стеклище":                 { cat: "plot", tip: i18n("Автор беспощаден к героям и твоим нервам") },
  ...
  // ── Игры ─────────────────────────────────────
  "Автобой":                    { cat: "special", tip: i18n("Игра сама играет в игру лучше тебя") },
