...
const TAGS_MAP = {
  ...
  "Короткая и ёмкая":           { cat: "special", tip: i18n("Пройдено на один вечер – понравилось") },
...
// ── Разовая тихая починка ссылок на обложки ─────
// Версии 0.5.21–0.5.25 умели пересжимать старые резервные копии
// обложек кнопкой в настройках – та переименовывала файлы (расширение
