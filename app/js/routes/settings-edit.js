...
async function saveSettings() {
  ...
  try {
    ...
    const savedNote = appInfo
      ? "Сохранено ✓"
      : i18n("Сохранено ✓ (обнови страницу на сайте, чтобы увидеть изменения)");
    flashStatus(statusId, data.ok, data.ok ? savedNote : i18n("Ошибка: ") + data.error);
