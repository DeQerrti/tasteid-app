  ...
  <div id="app" class="hidden">
    ...
    <main id="main">
      ...
      <div class="panel" id="panel-app">
        ...
        <!-- Только на телефоне: на компьютере установщик подписан и
             обновляется тем же способом, что и любая другая программа,
             без единого предупреждения системы. На телефоне же apk не
             из Play Store, и почти на каждом шаге – скачивание,
             установка – телефон или Play Защита может встать поперёк
             дороги, каждый раз по-своему и без объяснений от самой
             системы. Один диалог обновления слишком тесен для всего
             этого, поэтому подробности живут здесь. -->
        <div id="app-updates-section" class="hidden">
          <h2 class="section-h" data-i18n>Обновления на телефоне</h2>
          <p class="panel-intro" data-i18n>
            TasteID для Android не из Play Store – его негде публиковать
            без ежегодного взноса разработчика. Из-за этого при каждом
            обновлении телефон видит файл, который прислал не Play
            Store, и по умолчанию ему не доверяет: может отказаться его
            качать, предупредить перед установкой или заблокировать
            установку совсем. Это не ошибка и не значит, что с
            приложением что-то не так, – так ведёт себя любое
            приложение не из магазина.
          </p>
          <ol class="sync-intro" style="padding-left:1.2em;display:flex;flex-direction:column;gap:.7em;">
            <li data-i18n>
              Нажмите «Обновить» во всплывающем окне – в большинстве
              случаев файл скачается и установится сам, дальше только
              подтвердить установку, как для любого другого приложения.
            </li>
            <li data-i18n>
              Если вместо этого показывается ошибка скачивания – телефон,
              скорее всего, не дал приложению самому скачать файл,
              который пришёл не из Play Store. Нажмите «Поделиться» и
              выберите браузер (Chrome или любой другой) – в отличие от
              самого приложения, браузер умеет качать такие файлы
              напрямую с GitHub, откроется страница релиза и скачивание
              начнётся само.
            </li>
            <li data-i18n>
              Если браузер или Play Защита предупредят, что файл
              «может быть опасен» (обычное дело для файла не из Play
              Store) – там же будет ссылка вроде «Подробнее» или «Всё
              равно скачать/установить»: нажмите её, чтобы продолжить.
            </li>
            <li data-i18n>
              Если система прямо отказывается устанавливать скачанный
              файл – откройте Play Store → значок профиля → «Play
              Защита» → шестерёнка настроек → выключите «Сканировать
              приложения с помощью Play Защиты» и попробуйте установить
              ещё раз.
            </li>
            <li data-i18n>
              На телефонах не от Google (Xiaomi/MIUI, Samsung, Huawei и
              похожих) то же самое может дополнительно перепроверять
              собственное приложение безопасности производителя –
              обычно называется «Безопасность» или «Диспетчер телефона»:
              там тоже стоит поискать похожий переключатель, если ничего
              из перечисленного выше не помогло.
            </li>
          </ol>
        </div>
