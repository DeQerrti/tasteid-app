...
//  js/backup-history.js (общий для этого вида и панели «История
//  версий» внутри маршрута #/settings-edit — см. её же комментарий в
//  начале того файла), здесь только шапка и вызов
