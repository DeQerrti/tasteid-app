...
i18nRegister({
  ...
  "Отменить выбор нескольких": "Cancel multiple select",
  "Снять выбор": "Clear selection",
  "Выбрать файл": "Choose file",
  Год: "Year",
  "Год выхода": "Release year",
  "Добавить выбранных ({n})": "Add selected ({n})",
  Даты: "Dates",
  Диапазон: "Range",
  ...
  Галерея: "Gallery",
  "Удалить эту картинку из галереи?": "Delete this image from the gallery?",
  "Все обложки этого отзыва": "All covers of this review",
  "Все обложки ({v0})": "All covers ({v0})",
  "Все картинки этой записи": "All images for this entry",
  "Все картинки ({v0})": "All images ({v0})",
  Анкета: "Profile",
  Биография: "Biography",
  Пол: "Gender",
  Цитаты: "Quotes",
  ...
  "Убрать поле": "Remove field",
  "Добавить цитаты": "Add quotes",
  "Название тайтла...": "Title name...",
  "Область картинки": "Image area",
  "Нажмите на картинку, чтобы выбрать центр области.": "Click the image to choose the center of the area.",
  "Предпросмотр:": "Preview:",
  "Пока нет привязанных тайтлов.": "No linked titles yet.",
  "Добавить персону": "Add person",
  "Добавить запись": "Add entry",
  "Имя...": "Name...",
  "Пока ничего не привязано.": "Nothing linked yet.",
  "Например: женский": "E.g. female",
  "По одной на строку": "One per line",
  "Свободный текст – история персонажа, факты о персоне...":
    "Free text – character history, facts about the person...",
  Формат: "Format",
  Цвет: "Colour",
