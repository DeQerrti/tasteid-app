...
function passportIntroHtml() {
  ...
  return `
    ...
    <p class="panel-intro">
      ${i18n("Это не резервная копия: файл легче, чем твои настоящие данные (без текста отзывов, без избранного, без тир-листов), и загрузка сюда чужого паспорта ничего своего не трогает и не заменяет.")}
    </p>
