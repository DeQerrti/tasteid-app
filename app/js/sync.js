...
// settings-grades.js и deleteCurrentCollection в chars-edit.js). Без
// этого шага картинки раздела оставались бы висеть в репозитории, и
// автосинхронизация на следующем запуске молча тащила бы их обратно
// как "картинки, которых здесь никогда не было" – ровно тот же случай,
// что и с одной обложкой, просто на весь раздел сразу.
